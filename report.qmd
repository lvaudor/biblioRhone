...
Top 20 des articles les plus cités **par** le corpus:
...
```{r plot_collaboration_graph, fig.width=10,fig.height=10}
...
```{r co_citation_network, fig.width=10, fig.height=10}
M=M %>% 
...
```{r plot_graph_keywords, fig.width=10, fig.height=10}
net=networkPlot(NetMatrix,
                weighted=T, n = 150,
